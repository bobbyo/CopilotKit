...
class CopilotKitRemoteEndpoint:
    ...
    def __init__(
        ...
        *,
        ...
        # NOTE: Commented out AG-UI validation to allow LangGraphAgent with checkpointer
        # The LangGraphAGUIAgent migration is incomplete and breaks thread persistence
